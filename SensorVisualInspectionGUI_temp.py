...
sensor_type_selector = tk.OptionMenu(frame, sensor_type_var, "", "R0", "R1", "R2", "R3", 
"R4", "R5")
sensor_type_selector.place(x = entryX + 250, y = entryY - 30)
sensor_type_label = tk.Label(frame, text = "Type")
sensor_type_label.place(x = entryX + 220, y = entryY - 30)
...
id_label.place(x = entryX, y = entryY - 30)
id_box = tk.Entry(frame, textvariable = sn_variable, justify = 'left' , width = 20)
id_box.place(x = entryX + 30, y = entryY- 30)
